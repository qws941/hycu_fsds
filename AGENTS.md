...
│   ├── tests/
│   │   └── test_algorithms.py  # 18 unit tests (pytest/unittest)
│   └── scripts/
│       ├── competition_driver.py  # 697L - Pure Pursuit + V2X (MAIN)
│       ├── simple_slam.py         # 257L - Occupancy grid + TF tree
