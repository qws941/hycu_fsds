...
from driver.competition_driver import CompetitionDriver
from modules.perception.slam import SimpleSLAM

try:
    from modules.control.pure_pursuit import pure_pursuit_steering, get_lookahead_point
    from modules.control.speed import estimate_curvature, calculate_target_speed, apply_rate_limit
    from modules.perception.cone_detector import find_cones_filtered, build_centerline
    from modules.utils.watchdog import DriveState, StopReason, Watchdog
    SRC_AVAILABLE = True
except ImportError:
    SRC_AVAILABLE = False
...
class TestWatchdogStateMachine(unittest.TestCase):
    ...
    def test_cones_lost_does_not_auto_recover_via_watchdog(self):
        ...
        from driver.competition_driver import DriveState, StopReason
    ...
    def test_single_noise_cone_does_not_reset_timer(self):
        ...
        from driver.competition_driver import DriveState
